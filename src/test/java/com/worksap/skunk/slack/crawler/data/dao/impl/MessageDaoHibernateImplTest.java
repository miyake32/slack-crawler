package com.worksap.skunk.slack.crawler.data.dao.impl;
...
import com.worksap.skunk.slack.crawler.data.AbstractHibernateDataAccessTest;
...
public class MessageDaoHibernateImplTest extends AbstractHibernateDataAccessTest {
	...
	public void saveTest() {
		...
		System.out.println(messageDao.getFromLatest(channel, 10, "test"));
	}
}
