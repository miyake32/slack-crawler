...
import skunk.slack.crawler.api.spec.ChannelsHistory;
import skunk.slack.crawler.api.spec.ChannelsList;
import skunk.slack.crawler.api.spec.GroupsHistory;
import skunk.slack.crawler.api.spec.GroupsList;
import skunk.slack.crawler.api.spec.SlackAPISpec;
import skunk.slack.crawler.api.spec.UsersList;
...
import skunk.slack.crawler.parser.JsonResponseParser;
...
public class SlackClientGoogleImpl implements SlackClient {
	...
	public JsonResponseParseResult<Message> getMessages(Channel channel) {
		...
		SlackAPISpec<Message> converter = new ChannelsHistory(new UserService(this));
